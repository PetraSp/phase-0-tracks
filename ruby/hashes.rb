...
# - Print the hash back out to the screen when the designer has answered all of the questions. p client_information
# - Possibility to update a key (no loop)
# - Print the latest version of the hash, and exit the program

# Ask user for details of a given client
client_information = {
  name: "name",
  age: "age",
